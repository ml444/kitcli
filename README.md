# GoKit CLI  [![Build Status](https://travis-ci.org/ml444/kitcli.svg?branch=master)](https://travis-ci.org/ml444/kitcli)[![Go Report Card](https://goreportcard.com/badge/github.com/ml444/kitcli)](https://goreportcard.com/report/github.com/ml444/kitcli)[![Coverage Status](https://coveralls.io/repos/github/ml444/kitcli/badge.svg?branch=master)](https://coveralls.io/github/ml444/kitcli?branch=master)
This project is a more advanced version of [gk](https://github.com/ml444/gk).
...
```bash
go get github.com/ml444/kitcli
```
# Usage
```bash
kit help
